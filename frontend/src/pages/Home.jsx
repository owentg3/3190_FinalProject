  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen w-screen bg-gradient-to-b from-red-50 to-cyan-500">
      ...
      <div className="w-full flex justify-start pl-30">
        <div className="ml-32 h-12 w-50 text-left rounded-b-xl bg-gradient-to-t from-blue-700 to-teal-300 flex justify-center">
          <div className="relative inline-block text-left dropdown">
            <button
              onClick={toggleDropdown}
              className="bg-teal-500 text-black px-2 py-2 rounded-b-xl focus:outline-none w-45"
            >
              Genres ▼
            </button>
            {isDropdownOpen && (
                ...
                <div className="py-1">
                  {uniqueGenres.map((genre, i) => (
                    <button
                      ...
                      className="block w-full text-left px-4 py-2 text-sm text-black hover:bg-gray-700"
                    >
                      {genre}
                    </button>
                  ))}
            ...
            <React.Fragment key={index}>
              ...
              >
                ...
                <img
                  ...
                  alt={album.artist}
                  className="w-55 border-2 mx-auto mb-4 rounded-lg transition-transform duration-300 hover:scale-125"
                />
                <br></br>
                <div className="pl-30">
